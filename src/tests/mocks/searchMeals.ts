// Searching Meals by Ingredients (Chicken) Mock

const searchedMealsbyIngredients = {
  meals: [
    {
    ...
    },
    {
      ...
      strMealThumb: 'https://www.themealdb.com/images/media/meals/x8l8s41583266727.jpg',
      idMeal: '53026',
    },
    {
...
export default searchedMealsbyIngredients;
